// DIVERGENCE(upstream): enums imported from ../types (upstream leaks them from the toolbar component)
import type { OutputDetailLevel, ReactComponentMode, Annotation } from "../types";
