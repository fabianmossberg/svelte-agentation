...
## Page Feedback: /checkout
**Viewport:** unknown

### 1. 3 elements: button "Save", link "Docs", img +1 more
**Location:** multi-select
**Classes:** cta cta-primary
**Position:** 100px, 281px (420×130px)
**Context:** Complete your purchase
**Feedback:** Align these two CTAs and the badge